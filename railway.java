...
public class railway {
   ...
   //-------------------------------------------------------
    ...
    public static void main(String[] args){
        ...
        System.out.flush();
        userid.add("19cs026@kpriet.ac.in");
        password.add(12345);
        username.add("Dejesh");
        userbookid.add(10000);
        userid.add("19cs008@kpriet.ac.in");
        password.add(12345);
        username.add("Akash");
    ...
    public static void ticketbooking(){
        ...
        for(int i=0;i<ticket.length;i++){
            ...
            if(count==distance && possibility==true)
               System.out.println("Available seat No: "+(i+1));
        ...
        if(possibility==false) {
            System.out.println("Sorry! 0 seats available, Currently your request in waiting list");
        //waiting list
        ...
        System.out.println();
        System.out.println("-----Enter the required seat no-----");
        ...
        System.out.println("Your Ticket Confirmation Id: "+ticketbookingid);
    ...
    System.out.print("\033[H\033[2J");
        ...
        for(int i=0;i<travellername.size();i++){
            if((travellername.get(i)).equals(name)){
                ...
                System.out.println("Ticket Id       :"+travellerbookid.get(i));
